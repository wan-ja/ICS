        ...
        retrofitAPI.getItemsByItemName(str).enqueue(new Callback<ItemResponseDto>() {
            ...
            public void onResponse(Call<ItemResponseDto> call, Response<ItemResponseDto> response) {
                if(response.isSuccessful()) {
                    ...
                    Toast.makeText(UmbrellaActivity.this, "성공적으로 불러왔습니다.", Toast.LENGTH_SHORT).show();
                }
                // response 400~500 (에러 발생)
                    ...
                    try {
                        ...
                        Toast.makeText(UmbrellaActivity.this, jsonObjError.getJSONObject("result").getString("msg"), Toast.LENGTH_LONG).show();
                    } catch(IOException e) {
                        Toast.makeText(UmbrellaActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(Call<ItemResponseDto> call, Throwable t) {
                Toast.makeText(UmbrellaActivity.this, "통신에 실패하였습니다.", Toast.LENGTH_SHORT).show();
            }
        });
